# -*- coding: utf-8 -*-
# $Id: failurereason.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class FailureReasonLogic(ModelLogicBase): # pylint: disable=R0903
    ...
    def addEntry(self, oFailureReasonData, uidAuthor, fCommit=True):
        ...
        self._oDb.execute('INSERT INTO FailureReasons (\n'
                          ...
                          ')\n'
                          'VALUES (%s, %s, %s, %s, %s, %s)',
                          (uidAuthor, oFailureReasonData.idFailureCategory,
                           oFailureReasonData.sShort, oFailureReasonData.sFull,
                           oFailureReasonData.iTicket, oFailureReasonData.asUrls));
        if fCommit:
            self._oDb.commit();
    ...
    def editEntry(self, oFailureReasonData, uidAuthor, fCommit=True):
        ...
        # Historize record
        self.remove(uidAuthor, oFailureReasonData.idFailureReason, fNeedCommit=False);
        ...
        self._oDb.execute('INSERT INTO FailureReasons (\n'
                          ...
                          (oFailureReasonData.idFailureReason, uidAuthor,
