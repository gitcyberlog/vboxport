# -*- coding: utf-8 -*-
# $Id: coreconsts.py 52776 2014-09-17 14:51:43Z vboxsync $
...
g_kasOses = ['darwin', 'dos', 'dragonfly', 'freebsd', 'haiku', 'l4', 'linux', 'netbsd', 'nt', 'openbsd', 'os2', 'solaris', 'win'];
...
g_kasCpuArches = ['amd64', 'x86', 'sparc32', 'sparc64', 's390', 's390x', 'ppc32', \
    'ppc64', 'mips32', 'mips64', 'ia64', 'hppa32', 'hppa64', 'arm', 'alpha'];
## All known CPU architectures, except the agnostic one.
# See KBUILD_ARCHES in kBuild/header.kmk for reference.
...
g_kasOsDotCpus = \
    ['darwin.amd64', 'darwin.x86', 'darwin.ppc32', 'darwin.ppc64', 'darwin.arm', \
        'dos.x86', 'dragonfly.amd64', 'dragonfly.x86', 'freebsd.amd64', 'freebsd.x86', \
        'freebsd.sparc64', 'freebsd.ia64', 'freebsd.ppc32', 'freebsd.ppc64', \
        'freebsd.arm', 'freebsd.mips32', 'freebsd.mips64', 'haiku.amd64', 'haiku.x86', \
        'l4.amd64', 'l4.x86', 'l4.ppc32', 'l4.ppc64', 'l4.arm', 'nt.amd64', 'nt.x86', \
        'nt.arm', 'nt.ia64', 'nt.mips32', 'nt.ppc32', 'nt.alpha', 'win.amd64', \
        'win.x86', 'win.arm', 'win.ia64', 'win.mips32', 'win.ppc32', 'win.alpha', \
        'os2.x86', 'solaris.amd64', 'solaris.x86', 'solaris.sparc32', 'solaris.sparc64'];
# 'solaris.sparc64',];
