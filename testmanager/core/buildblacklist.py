# -*- coding: utf-8 -*-
# $Id: buildblacklist.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class BuildBlacklistData(ModelDataBase):
    ...
    kasAllowNullAttributes = ['idBlacklisting', 'tsEffective', 'tsExpire', 'uidAuthor', \
        'asTypes', 'asOsArches'];
...
class BuildBlacklistLogic(ModelLogicBase): # pylint: disable=R0903
    ...
    def addEntry(self, oData, uidAuthor, fCommit=False):
        ...
        self._oDb.execute('INSERT INTO BuildBlacklist (\n'
                          ...
                          (uidAuthor, oData.idFailureReason, oData.sProduct, \
                          oData.sBranch, oData.asTypes, oData.asOsArches, \
                          oData.iFirstRevision, oData.iLastRevision,));
    ...
    def _readdEntry(self, uidAuthor, oData, tsEffective=None):
        ...
        self._oDb.execute('INSERT INTO BuildBlacklist (\n'
                          ...
                          (uidAuthor, tsEffective, oData.idBlacklisting, \
                          oData.idFailureReason, oData.sProduct, oData.sBranch, \
