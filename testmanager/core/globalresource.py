# -*- coding: utf-8 -*-
# $Id: globalresource.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class GlobalResourceLogic(ModelLogicBase):
    ...
    def addGlobalResource(self, uidAuthor, oData):
        ...
        self._oDb.execute('SELECT * FROM add_globalresource(%s, %s, %s, %s);', \
            (uidAuthor, oData.sName, oData.sDescription, oData.fEnabled));
        self._oDb.commit();
        return True
    ...
    def editGlobalResource(self, uidAuthor, idGlobalRsrc, oData):
        ...
        (uidAuthor, idGlobalRsrc, oData.sName, oData.sDescription, oData.fEnabled));
        self._oDb.commit();
        return True
    ...
    def allocateResources(self, idTestBox, aoGlobalRsrcs, fCommit=False):
        ...
        for oGlobalRsrc in aoGlobalRsrcs:
            try:
                self._oDb.execute('INSERT INTO GlobalResourceStatuses (idGlobalRsrc,' \
                    ' idTestBox)\n VALUES (%s, %s)', (oGlobalRsrc.idGlobalRsrc, \
                    idTestBox,));
