# -*- coding: utf-8 -*-
# $Id: failurecategory.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class FailureCategoryLogic(ModelLogicBase): # pylint: disable=R0903
    ...
    def addEntry(self, oFailureCategoryData, uidAuthor, fCommit=True):
        ...
        self._oDb.execute('INSERT INTO FailureCategories (\n'
                          ...
                          ')\n'
                          'VALUES (%s, %s, %s)',
                          (uidAuthor, oFailureCategoryData.sShort,
    ...
    def editEntry(self, oFailureCategoryData, uidAuthor, fCommit=True):
        ...
        if oFailureCategoryDataOld is None:
            raise TMExceptionBase('Failure Category (id: %d) does not exist' \
        ...
        # Historize record
        self.remove(uidAuthor, oFailureCategoryData.idFailureCategory, fNeedCommit=False)

        self._oDb.execute('INSERT INTO FailureCategories (\n'
                          '  idFailureCategory, uidAuthor, sShort, sFull'
                          ')\n'
                          'VALUES (%s, %s, %s, %s)',
                          (oFailureCategoryData.idFailureCategory, uidAuthor,
                           oFailureCategoryData.sShort, oFailureCategoryData.sFull));
        if fCommit:
            self._oDb.commit()
