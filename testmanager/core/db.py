# -*- coding: utf-8 -*-
# $Id: db.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class TMDatabaseConnection(object):
    ...
    def debugTextReport(self, tsStart=0):
        ...
        for aEntry in self._aoTraceBack:
            ...
            % (iEntry, utils.formatNumber(aEntry[0] - tsStart), \
            utils.formatNumber(aEntry[2]), utils.formatNumber(aEntry[3]), aEntry[4],);
            sDebug += '\n' + sHdr + '\n' + '-' * len(sHdr) + '\n';
