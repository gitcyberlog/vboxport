# -*- coding: utf-8 -*-
# $Id: testcaseargs.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class TestCaseArgsData(ModelDataBase):
    ...
    kasAllowNullAttributes = ['idTestCase', 'idTestCaseArgs', 'tsEffective', \
        'tsExpire', 'uidAuthor', 'idGenTestCaseArgs', 'cSecTimeout', \
    ...
    def initFromValues(self, sArgs, cSecTimeout=None, sTestBoxReqExpr=None, \
        sBuildReqExpr=None, cGangMembers=1, idTestCase=None, idTestCaseArgs=None, \
        tsEffective=None, tsExpire=None, uidAuthor=None, idGenTestCaseArgs=None):
