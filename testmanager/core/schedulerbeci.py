# -*- coding: utf-8 -*-
# $Id: schedulerbeci.py 52776 2014-09-17 14:51:43Z vboxsync $
        ...
        while len(aoItems) < cMaxItems:
            ...
            for iPrio in range(iMaxPriority, iMinPriority - 1, -1):
                ...
                for oTestGroup in oData.aoTestGroups:
                    ...
                    for oTestCase in oTestGroup.aoTestCases:
                        self.msgDebug('testcase loop: idTestCase=%s' \
                            % (oTestCase.idTestCase,));
                        if iPrio <= oTestCase.iBeciPrio  and  len(\
                            oTestCase.aoArgsVariations) > 0:
                            # Get variation.
                            ...
                            oItem.initFromValues(idSchedGroup=\
self._oSchedGrpData.idSchedGroup, idGenTestCaseArgs=\
oArgsVariation.idGenTestCaseArgs, idTestGroup=oTestGroup.idTestGroup, \
aidTestGroupPreReqs=oTestGroup.aidTestGroupPreReqs, \
bmHourlySchedule=oTestGroup.bmHourlySchedule, cMissingGangMembers=\
oArgsVariation.cGangMembers, offQueue=len(aoItems));
