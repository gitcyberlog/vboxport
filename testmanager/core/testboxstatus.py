# -*- coding: utf-8 -*-
# $Id: testboxstatus.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class TestBoxStatusData(ModelDataBase):
    ...
    kasValidValues_enmState = [ksTestBoxState_Idle, ksTestBoxState_Testing, \
        ksTestBoxState_GangGathering, ksTestBoxState_GangGatheringTimedOut, \
        ksTestBoxState_GangTesting, ksTestBoxState_GangCleanup, \
        ksTestBoxState_Rebooting, ksTestBoxState_Upgrading, \
        ksTestBoxState_UpgradingAndRebooting, ksTestBoxState_DoingSpecialCmd,];
...
class TestBoxStatusLogic(ModelLogicBase):
    ...
    def tryFetchStatusAndConfig(self, idTestBox, sTestBoxUuid, sTestBoxAddr):
        ...
        self._oDb.execute('SELECT   *\n'
                          ...
                          '     AND TestBoxes.ip         = %s\n'
                          , (idTestBox, idTestBox, sTestBoxUuid, sTestBoxAddr,));
