# -*- coding: utf-8 -*-
# $Id: wuifailurecategory.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class WuiFailureCategory(WuiFormContentBase):
    ...
    def __init__(self, oFailureCategoryData, sMode, oDisp):
        ...
        WuiFormContentBase.__init__(self, oFailureCategoryData, sMode, \
        'FailureCategory', oDisp, sTitle, sSubmitAction=sSubmitAction, \
...
class WuiFailureCategoryList(WuiListContentBase):
    ...
    def __init__(self, aoEntries, iPage, cItemsPerPage, tsEffective, fnDPrint, oDisp):
        ...
        tsEffective, sTitle='Failure Categories', sId='failureCategories', \
    ...
    def _formatListEntry(self, iEntry):
        ...
        return [oEntry.idFailureCategory, oEntry.sShort, oEntry.sFull, \
            [WuiTmLink('Modify', WuiAdmin.ksScriptName, \
                ...
                sConfirm='Do you really want to remove failure cateogry #%d?' \
