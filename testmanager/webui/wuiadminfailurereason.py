# -*- coding: utf-8 -*-
# $Id: wuiadminfailurereason.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class WuiAdminFailureReason(WuiFormContentBase):
    ...
    def __init__(self, oFailureReasonData, sMode, oDisp):
        ...
        'FailureReason', oDisp, sTitle, sSubmitAction=sSubmitAction, \
        fEditable=False); ## @todo non-standard action names.
    ...
    def _populateForm(self, oForm, oData):
        ...
        oForm.addTimestampRO(FailureReasonData.ksParam_tsExpire, oData.tsExpire, \
            'Expires (excl)');
        ...
        oForm.addComboBox(FailureReasonData.ksParam_idFailureCategory, \
            oData.idFailureCategory, 'Failure Category', aoFailureCategories);
        ...
        oForm.addInt(FailureReasonData.ksParam_iTicket, oData.iTicket, \
            'Ticket Number');
        oForm.addMultilineText(FailureReasonData.ksParam_asUrls, oData.asUrls, \
...
class WuiAdminFailureReasonList(WuiListContentBase):
    ...
    def __init__(self, aoEntries, iPage, cItemsPerPage, tsEffective, fnDPrint, oDisp):
        ...
        tsEffective, sTitle='Failure Reasons', sId='failureReasons', \
    ...
    def _formatListEntry(self, iEntry):
        ...
        return [oEntry.idFailureReason, oEntry.idFailureCategory, oEntry.sShort, \
            oEntry.sFull, oEntry.iTicket, oEntry.asUrls, \
            ...
            FailureReasonData.ksParam_idFailureReason: oEntry.idFailureReason}, \
            sConfirm='Are you sure you want to remove failure reason #%d?' \
            % (oEntry.idFailureReason,)),]];
