# -*- coding: utf-8 -*-
# $Id: wuiadmin.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class WuiAdmin(WuiDispatcherBase):
    ...
    def __init__(self, oSrvGlue):
        ...
        d[self.ksActionUserAddPost] = lambda: self._actionGenericFormAddPost(\
            UserAccountData, UserAccountLogic, WuiUserAccount, self.ksActionUserList)
        ...
        d[self.ksActionUserDelPost] = lambda: self._actionGenericDoRemove(\
            UserAccountLogic, UserAccountData.ksParam_uid, self.ksActionUserList)
        #
        # TestBox actions.
        #
        ...
        d[self.ksActionTestBoxAddPost] = lambda: self._actionGenericFormAddPost(\
        ...
        d[self.ksActionTestBoxEditPost] = lambda: self._actionGenericFormEditPost(\
            TestBoxData, TestBoxLogic, WuiTestBox, self.ksActionTestBoxList);
        d[self.ksActionTestBoxRemovePost] = lambda: self._actionGenericDoRemove(\
            TestBoxLogic, TestBoxData.ksParam_idTestBox, self.ksActionTestBoxList)
        ...
        d[self.ksActionTestCaseAddPost] = lambda: self._actionGenericFormAddPost(\
            TestCaseDataEx, TestCaseLogic, WuiTestCase, self.ksActionTestCaseList);
        d[self.ksActionTestCaseClone] = lambda: self._actionGenericFormClone(\
            TestCaseDataEx, WuiTestCase, 'idTestCase', 'idGenTestCase');
        d[self.ksActionTestCaseDetails] = lambda: self._actionGenericFormDetails(\
            TestCaseDataEx, TestCaseLogic, WuiTestCase, 'idTestCase', 'idGenTestCase');
        ...
        d[self.ksActionTestCaseEditPost] = lambda: self._actionGenericFormEditPost(\
            TestCaseDataEx, TestCaseLogic, WuiTestCase, self.ksActionTestCaseList);
        d[self.ksActionTestCaseDoRemove] = lambda: self._actionGenericDoRemove(\
            TestCaseLogic, TestCaseData.ksParam_idTestCase, self.ksActionTestCaseList);
        ...
        d[self.ksActionGlobalRsrcShowAdd] = lambda: self._actionGlobalRsrcShowAddEdit(\
            WuiAdmin.ksActionGlobalRsrcAdd)
        d[self.ksActionGlobalRsrcShowEdit] = lambda: self._actionGlobalRsrcShowAddEdit(\
        ...
        d[self.ksActionGlobalRsrcDel] = lambda: self._actionGenericDoDelOld(\
            GlobalResourceLogic, GlobalResourceData.ksParam_idGlobalRsrc, \
        ...
        d[self.ksActionBuildSrcAddPost] = lambda: self._actionGenericFormAddPost(\
        BuildSourceData, BuildSourceLogic, WuiAdminBuildSrc, self.ksActionBuildSrcList);
        d[self.ksActionBuildSrcClone] = lambda: self._actionGenericFormClone(\
            BuildSourceData, WuiAdminBuildSrc, 'idBuildSrc');
        d[self.ksActionBuildSrcDetails] = lambda: self._actionGenericFormDetails(\
        ...
        d[self.ksActionBuildSrcDoRemove] = lambda: self._actionGenericDoRemove(\
            BuildSourceLogic, BuildSourceData.ksParam_idBuildSrc, \
                self.ksActionBuildSrcList);
        d[self.ksActionBuildSrcEdit] = lambda: self._actionGenericFormEdit(\
            BuildSourceData, WuiAdminBuildSrc, BuildSourceData.ksParam_idBuildSrc);
        d[self.ksActionBuildSrcEditPost] = lambda: self._actionGenericFormEditPost(\
        BuildSourceData, BuildSourceLogic, WuiAdminBuildSrc, self.ksActionBuildSrcList);
        ...
        # Build actions
        #
        d[self.ksActionBuildList] = lambda: self._actionGenericListing(BuildLogic, \
            WuiAdminBuildList)
        d[self.ksActionBuildAdd] = lambda: self._actionGenericFormAdd(BuildData, \
            WuiAdminBuild)
        ...
        d[self.ksActionBuildClone] = lambda: self._actionGenericFormClone(BuildData, \
        ...
        d[self.ksActionBuildEdit] = lambda: self._actionGenericFormEdit(BuildData, \
            WuiAdminBuild, BuildData.ksParam_idBuild);
        d[self.ksActionBuildEditPost] = lambda: self._actionGenericFormEditPost(\
            BuildData, BuildLogic, WuiAdminBuild, self.ksActionBuildList)
        ...
        d[self.ksActionBuildBlacklistAddPost] = lambda: self._actionGenericFormAddPost(\
            BuildBlacklistData, BuildBlacklistLogic, WuiAdminBuildBlacklist, \
                self.ksActionBuildBlacklist);
        d[self.ksActionBuildBlacklistClone] = lambda: self._actionGenericFormClone(\
            BuildBlacklistData, WuiAdminBuildBlacklist, 'idBlacklisting');
        d[self.ksActionBuildBlacklistDetails] = lambda: self._actionGenericFormDetails(\
            BuildBlacklistData, BuildBlacklistLogic, WuiAdminBuildBlacklist, \
                'idBlacklisting');
        d[self.ksActionBuildBlacklistDoRemove] = lambda: self._actionGenericDoRemove(\
            BuildBlacklistLogic, BuildBlacklistData.ksParam_idBlacklisting, \
                self.ksActionBuildBlacklist)
        d[self.ksActionBuildBlacklistEdit] = lambda: self._actionGenericFormEdit(\
            BuildBlacklistData, WuiAdminBuildBlacklist, \
                BuildBlacklistData.ksParam_idBlacklisting);
        d[self.ksActionBuildBlacklistEditPost] = lambda: \
            self._actionGenericFormEditPost(BuildBlacklistData, BuildBlacklistLogic, \
        ...
        d[self.ksActionFailureCategoryShowEdit] = lambda: \
            self._actionGenericFormEditL(FailureCategoryLogic, \
                FailureCategoryData.ksParam_idFailureCategory, WuiFailureCategory)
        ...
        FailureCategoryLogic, FailureCategoryData.ksParam_idFailureCategory, \
            self.ksActionFailureCategoryList)
        ...
        d[self.ksActionBuildCategoryAddPost] = lambda: self._actionGenericFormAddPost(\
            BuildCategoryData, BuildCategoryLogic, WuiAdminBuildCat, \
                self.ksActionBuildCategoryList);
        d[self.ksActionBuildCategoryClone] = lambda: self._actionGenericFormClone(\
            BuildCategoryData, WuiAdminBuildCat, 'idBuildCategory');
        d[self.ksActionBuildCategoryDetails] = lambda: \
            self._actionGenericFormDetails(BuildCategoryData, BuildCategoryLogic, \
                WuiAdminBuildCat, 'idBuildCategory');
        d[self.ksActionBuildCategoryDoRemove] = lambda: self._actionGenericDoRemove(\
        ...
        d[self.ksActionTestGroupAddPost] = lambda: self._actionGenericFormAddPost(\
            TestGroupDataEx, TestGroupLogic, WuiTestGroup, \
        ...
        d[self.ksActionTestGroupDetails] = lambda: self._actionGenericFormDetails(\
        ...
        d[self.ksActionTestGroupEditPost] = lambda: self._actionGenericFormEditPost(\
            TestGroupDataEx, TestGroupLogic, WuiTestGroup, \
                self.ksActionTestGroupList);
        d[self.ksActionTestGroupDoRemove] = lambda: self._actionGenericDoRemove(\
            TestGroupLogic, TestGroupDataEx.ksParam_idTestGroup, \
                self.ksActionTestGroupList);
        ...
        d[self.ksActionSchedGroupDetails] = lambda: self._actionGenericFormDetails(\
        ...
        d[self.ksActionSchedGroupEdit] = lambda: self._actionGenericFormEdit(\
            SchedGroupDataEx, WuiSchedGroup, SchedGroupData.ksParam_idSchedGroup);
        d[self.ksActionSchedGroupAddPost] = lambda: self._actionGenericFormAddPost(\
            SchedGroupDataEx, SchedGroupLogic, WuiSchedGroup, \
                self.ksActionSchedGroupList);
        d[self.ksActionSchedGroupEditPost] = lambda: self._actionGenericFormEditPost(\
            SchedGroupDataEx, SchedGroupLogic, WuiSchedGroup, \
                self.ksActionSchedGroupList);
        d[self.ksActionSchedGroupDoRemove] = lambda: self._actionGenericDoRemove(\
            SchedGroupLogic, SchedGroupData.ksParam_idSchedGroup, \
                self.ksActionSchedGroupList)
        ...
        [
            ...
            ['> Test Results', 'index.py?' + webutils.encodeUrlParams(\
                self._dDbgParams), []],
        ];
    ...
    def _actionGenericDoRemove(self, oLogicType, sParamId, sRedirAction):
        ...
        try:
            ...
            return oLogicType(self._oDb).removeEntry(self._oCurUser.uid, idEntry, \
                fCascade=fCascade, fCommit=True);
        except Exception as oXcpt:
            self._oDb.rollback();
    ...
    def _actionTestBoxListPost(self):
        ...
        # Parameters.
        aidTestBoxes = self.getListOfIntParams(TestBoxData.ksParam_idTestBox, \
            iMin=1, aiDefaults=[]);
    ...
    def _actionGlobalRsrcShowAddEdit(self, sAction): # pylint: disable=C0103
        ...
        if sAction == WuiAdmin.ksActionGlobalRsrcEdit:
            idGlobalRsrc = self.getIntParam(GlobalResourceData.ksParam_idGlobalRsrc, \
                iDefault=-1)
