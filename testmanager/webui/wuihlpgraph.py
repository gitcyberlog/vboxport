# -*- coding: utf-8 -*-
# $Id: wuihlpgraph.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class WuiHlpGraphDataTableEx(object): # pylint: disable=R0903
    ...
    def addDataSeries(self, sName, aoXValues, aoYValues, asHtmlTooltips=None, \
        aoYErrorBarBelow=None, aoYErrorBarAbove=None):
        """Adds an data series to the table."""
        self.aoSeries.append(WuiHlpGraphDataTableEx.DataSeries(sName, aoXValues, \
            aoYValues, asHtmlTooltips, aoYErrorBarBelow, aoYErrorBarAbove));
        return True;
