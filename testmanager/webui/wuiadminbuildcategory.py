# -*- coding: utf-8 -*-
# $Id: wuiadminbuildcategory.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class WuiAdminBuildCatList(WuiListContentBase):
    ...
    def __init__(self, aoEntries, iPage, cItemsPerPage, tsEffective, fnDPrint, oDisp):
        ...
        tsEffective, sTitle='Build Categories', sId='buildcategories', \
        fnDPrint=fnDPrint, oDisp=oDisp);
        self._asColumnHeaders = (['ID', 'Product', 'Repository', 'Branch', \
            'Build Type', 'OS/Architectures', 'Actions']);
    ...
    def _formatListEntry(self, iEntry):
        ...
        return [oEntry.idBuildCategory, oEntry.sRepository, oEntry.sProduct, \
            oEntry.sBranch, oEntry.sType, WuiRawHtml(sHtml), aoActions,];
...
class WuiAdminBuildCat(WuiFormContentBase):
    ...
    def __init__(self, oData, sMode, oDisp):
        ...
        WuiFormContentBase.__init__(self, oData, sMode, 'BuildCategory', oDisp, \
            sTitle, fEditable=False);
