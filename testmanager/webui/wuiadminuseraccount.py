# -*- coding: utf-8 -*-
# $Id: wuiadminuseraccount.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class WuiUserAccountList(WuiListContentBase):
    ...
    def __init__(self, aoEntries, iPage, cItemsPerPage, tsEffective, fnDPrint, oDisp):
        ...
        self._asColumnHeaders = ['User ID', 'Name', 'E-mail', 'Full Name', \
            'Login Name', 'Actions'];
    ...
    def _formatListEntry(self, iEntry):
        ...
        return [oEntry.uid, oEntry.sUsername, oEntry.sEmail, oEntry.sFullName, \
            oEntry.sLoginName, \
                 ...
                 WuiTmLink('Remove', WuiAdmin.ksScriptName, \
                    {WuiAdmin.ksParamAction: WuiAdmin.ksActionUserDelPost, \
                        UserAccountData.ksParam_uid: oEntry.uid}, \
                            sConfirm='Are you sure you want to remove user #%d?' \
                            % (oEntry.uid,)),]];
