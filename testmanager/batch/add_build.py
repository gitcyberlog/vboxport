#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: add_build.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class Build(object): # pylint: disable=R0903
    ...
    def add(self):
        ...
        oBuildData.oCat = BuildCategoryData().initFromValues(\
            sProduct=self.oConfig.sProductName, sRepository=self.oConfig.sRepository, \
            sBranch=self.oConfig.sBranch, sType=self.oConfig.sBuildType, \
