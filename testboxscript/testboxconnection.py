# -*- coding: utf-8 -*-
# $Id: testboxconnection.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class TestBoxResponse(object):
    ...
    def __init__(self, oResponse):
        ...
        if oResponse is not None:
            ...
            if sContentType is None  or  sContentType != \
...
class TestBoxConnection(object):
    ...
    def requestCommandWithConnection(sTestManagerUrl, sTestBoxId, sTestBoxUuid, fBusy):
        ...
        oConnection = None;
        try:
            oConnection = TestBoxConnection(sTestManagerUrl, sTestBoxId, \
                sTestBoxUuid, fLongTimeout=not fBusy);
            if fBusy:
                oResponse = oConnection.postRequest(\
                    constants.tbreq.REQUEST_COMMAND_BUSY);
            else:
                oResponse = oConnection.postRequest(\
                    constants.tbreq.REQUEST_COMMAND_IDLE);
