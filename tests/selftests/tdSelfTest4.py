#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: tdSelfTest4.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class tdSelfTest4(TestDriverBase):
    ...
    ## Valid tests.
    kasValidTests = ['immediate-sub-tests', 'total-sub-tests', \
        'immediate-values', 'total-values', 'immediate-messages'];
