#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: tdGuestOsInstTest1.py 54086 2015-02-05 14:06:21Z vboxsync $
...
class InstallTestVm(vboxtestvms.TestVm):
    ...
    def __init__(self, oSet, sVmName, sKind, sInstallIso, sHdCtrlNm, cGbHdd, fFlags):
        vboxtestvms.TestVm.__init__(self, oSet, sVmName, sKind=sKind, \
            sHddControllerType=sHdCtrlNm, fRandomPvPMode=(\
                fFlags & self.kfNoWin81Paravirt) == 0);
    ...
    def detatchAndDeleteHd(self, oTestDrv):
        ...
        if oVM is not None:
            ...
            if oSession is not None:
                (fRc, oHd) = oSession.detachHd(self.sHddControllerType, \
                    iPort=0, iDevice=0);
        ...
        if fRc is True:
            ...
            if oSession is not None:
                ...
                fRc = fRc and oSession.createAndAttachHd(sHddPath, \
                    ...
                    sController=self.sHddControllerType, iPort=0, \
                    fImmutable=False);
...
class tdGuestOsInstTest1(vbox.TestDriver):
    ...
    def __init__(self):
        ...
        oSet.aoTestVms.extend([
            ...
            ## @todo disable paravirt for Windows 8.1 guests as long
            #   as it's not fixed in the code
...
##            # --lb--pylint--lb--: --lb--enable--lb--=C0301
    ...
    def testOneVmConfig(self, oVM, oTestVm):
        ...
        oSession, _ = self.startVmAndConnectToTxsViaTcp(oTestVm.sVmName, \
            fCdWait=False, cMsTimeout=cMsTimeout);
        if oSession is not None:
