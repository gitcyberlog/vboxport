#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: tdAddBasic1.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class tdAddBasic1(vbox.TestDriver):                                         # pylint: disable=R0902
    ...
    def testOneCfg(self, oVM, oTestVm):
        ...
        self.logVmInfo(oVM);
        oSession, oTxsSession = self.startVmAndConnectToTxsViaTcp(oTestVm.sVmName, fCdWait=True, sFileCdWait='AUTORUN.INF');
