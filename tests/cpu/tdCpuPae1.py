#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: tdCpuPae1.py 52776 2014-09-17 14:51:43Z vboxsync $
...
class tdCpuPae1(vbox.TestDriver):
    ...
    def actionConfig(self):
        ...
        oVM = self.createTestVM('tst-bs-pae', 2, sKind='Other', fVirtEx=False, \
            fPae=False, sFloppy=os.path.join(self.sVBoxBootSectors, \
            'bootsector-pae.img'));
        if oVM is None:
            return False;
        return True;
